...
Jemplate.templateMap['jt.html'] = function(context) {
...
Jemplate.templateMap['applet'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
...
Jemplate.templateMap['item_list_item'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
...
Jemplate.templateMap['toolbar_select'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
